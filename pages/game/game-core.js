...
class Game {
    ...
    initInput() {
        // 使用微信的触摸事件
        this.canvas.addEventListener('touchstart', (res) => {
            res.preventDefault();
            if (this.state === 'playing') {
                ...
                if (x > this.canvas.width * 0.8 && y < this.canvas.height * 0.3) {
        ...
        this.canvas.addEventListener('touchmove', (res) => {
            res.preventDefault();
